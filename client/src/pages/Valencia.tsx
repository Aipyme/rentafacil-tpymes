        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-white/70 max-w-3xl leading-relaxed mb-8">
              Cada comunidad tiene sus propias deducciones y tramos. Analizamos tu caso con la normativa valenciana para que sepas exactamente qué te corresponde.
            </p>
            ...
            {[
              {
                ...
                desc: "Antes de empezar, evaluamos tu situación para indicarte la mejor forma de gestionar tu declaración en la Comunitat Valenciana.",
              },
              {
      ...
      <Section className="py-20 bg-navy text-white">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <h2 className="font-heading text-3xl md:text-4xl font-bold mb-6">
            ...
            <br />
            <span className="text-emerald">con la normativa valenciana</span>
          </h2>
